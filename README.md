...
- [Observability](docs/programs/observability.md) — push alerting via the
  existing self-hosted ntfy (URL kept as an agenix secret), failure hooks,
  the weekly health digest, earlyoom, sysstat, journald cap, and the
  rack-UPS watcher.
